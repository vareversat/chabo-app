            ...
            title: Row(
              children: [
                const Padding(
                  ...
                  child: Icon(FontAwesomeIcons.bridgeCircleXmark,
                      color: Colors.red),
                ),
                Text(
                    chabanBridgeForecast.circulationClosingDateString(context)),
                const Text("\n"),
              ],
            ),
            subtitle: Row(
              children: [
                ...
                Text(chabanBridgeForecast
                    .circulationReOpeningDateString(context)),
              ],
            ),
            trailing: Text(
